...
FMaterialInstanceBasePropertyOverrides::FMaterialInstanceBasePropertyOverrides()
	...
	,bOverride_UseToonRendering(false)
	,TwoSided(0)
	...
	,bUseToonRendering(false)
	,ToonColor(FLinearColor(0.0f,0.0f,0.0f))
{
...
bool FMaterialInstanceBasePropertyOverrides::operator==(const FMaterialInstanceBasePropertyOverrides& Other)const
{
	return	bOverride_OpacityMaskClipValue == Other.bOverride_OpacityMaskClipValue &&
		...
		bOverride_UseToonRendering == Other.bOverride_UseToonRendering &&
		bUseToonRendering == Other.bUseToonRendering &&
		ToonColor == Other.ToonColor;
}
...
bool FMaterial::UseToonRendering() const
{
	return false;
}

FLinearColor FMaterial::GetToonColor() const
{
	return FLinearColor(0.0f, 0.0f, 0.0f);
}

float FMaterial::GetToonShininess() const
{
	return 0.0f;
}

FLinearColor FMaterial::GetToonOutlineColor() const
{
	return FLinearColor(0.0f, 0.0f, 0.0f);
}

float FMaterial::GetToonOutlineThickness() const
{
	return 0.0f;
}
...
FMaterialShaderParameters::FMaterialShaderParameters(const FMaterial* InMaterial)
{
	...
	bUseToonRendering =  InMaterial->UseToonRendering();
}
